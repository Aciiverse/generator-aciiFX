...
export default class extends Generator {
    ...
    async prompting() {
        ...
        this.log(yosay(`Welcome to the ${chalk.red("generator-aciifx-cli")} generator!`));
    ...
    writing() {
        ...
        if (!this.fs.exists(destinationEnvPath)) {
            this.fs.copy(this.templatePath("aciiFX/.env-template"), destinationEnvPath);
        }

        // copy template env file
        this.fs.copy(this.templatePath("aciiFX/.env-template"), this.destinationPath("aciiFX/.env-template"));
        ...
        if (this.answers.demo) {
            ...
            this.fs.copy(this.templatePath("demo"), this.destinationPath("demo"));
        }
    }
